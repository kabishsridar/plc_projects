...
log_path = r"C:\Users\kabish\.gemini\antigravity-ide\brain\6bb09710-7f3e-4443-b187-ad04e16ca8dc\scratch\build_b14_log.txt"
xml_path = r"C:\Users\kabish\.gemini\antigravity-ide\brain\6bb09710-7f3e-4443-b187-ad04e16ca8dc\scratch\batching14_complete.xml"

# Complete PLCopen XML for batching14 with both Auto and Semi-Auto FBD blocks
plcopen_xml = """<?xml version="1.0" encoding="utf-8"?>
<project xmlns="http://www.plcopen.org/xml/tc6_0200">
  <fileHeader companyName="" productName="Automation Builder 2.7 - Basic" productVersion="Automation Builder 2.7" creationDateTime="2026-08-27T18:25:00" />
...
with open(log_path, "w") as f:
    f.write("Starting build of batching14 FBD with blocks...\n")
    try:
        proj = projects.open(project_path)
        app = proj.find("Application", True)[0]
        
        # Remove test pous and old batching14
        for name in ["test_fbd_boxes", "test_fbd_pou", "batching14"]:
            matches = proj.find(name, True)
            for m in matches:
                m.remove()
                f.write("Removed " + name + "\n")
                
        # Import the complete batching14 FBD
        f.write("Importing complete batching14 FBD...\n")
        app.import_xml(xml_path)
        f.write("batching14 FBD imported successfully with all visual blocks and pins!\n")
