...
log_path = r"C:\Users\kabish\.gemini\antigravity-ide\brain\6bb09710-7f3e-4443-b187-ad04e16ca8dc\scratch\update_b14_log.txt"
xml_path = r"C:\Users\kabish\.gemini\antigravity-ide\brain\6bb09710-7f3e-4443-b187-ad04e16ca8dc\scratch\b14_clean_fbd.xml"

b14_xml = """<?xml version="1.0" encoding="utf-8"?>
<project xmlns="http://www.plcopen.org/xml/tc6_0200">
  <fileHeader companyName="" productName="Automation Builder 2.7 - Basic" productVersion="Automation Builder 2.7" creationDateTime="2026-09-01T00:30:00" />
      ...
      <pou name="batching14" pouType="program">
        <interface>
          <localVars>
            ...
            <variable name="Read_Scales"><type><derived name="sample_read_two_weights" /></type></variable>
          </localVars>
        </interface>
        <body>
          <FBD>
            ...
            <!-- Network 1: Read_Scales (sample_read_two_weights) - Method 3 No BLINK -->
            <inVariable localId="10001"><position x="50" y="50" /><connectionPointOut /><expression>TRUE</expression></inVariable>
            <inVariable localId="10002"><position x="50" y="70" /><connectionPointOut /><expression>1</expression></inVariable>
            <inVariable localId="10003"><position x="50" y="90" /><connectionPointOut /><expression>1</expression></inVariable>
            <inVariable localId="10004"><position x="50" y="110" /><connectionPointOut /><expression>2</expression></inVariable>
            <inVariable localId="10005"><position x="50" y="130" /><connectionPointOut /><expression>10.0</expression></inVariable>
            <inVariable localId="10006"><position x="50" y="150" /><connectionPointOut /><expression>10.0</expression></inVariable>
            <inVariable localId="10007"><position x="50" y="170" /><connectionPointOut /><expression>FALSE</expression></inVariable>
            <inVariable localId="10008"><position x="50" y="190" /><connectionPointOut /><expression>FALSE</expression></inVariable>

            <block localId="10010" typeName="sample_read_two_weights" instanceName="Read_Scales">
              <position x="250" y="50" />
              <inputVariables>
                <variable formalParameter="Enable"><connectionPointIn><connection refLocalId="10001" /></connectionPointIn></variable>
                <variable formalParameter="Com_Slot"><connectionPointIn><connection refLocalId="10002" /></connectionPointIn></variable>
                <variable formalParameter="Slave_Auto_ID"><connectionPointIn><connection refLocalId="10003" /></connectionPointIn></variable>
                <variable formalParameter="Slave_Semi_ID"><connectionPointIn><connection refLocalId="10004" /></connectionPointIn></variable>
                <variable formalParameter="iDivisor_Auto"><connectionPointIn><connection refLocalId="10005" /></connectionPointIn></variable>
                <variable formalParameter="iDivisor_Semi"><connectionPointIn><connection refLocalId="10006" /></connectionPointIn></variable>
                <variable formalParameter="Tare_Auto"><connectionPointIn><connection refLocalId="10007" /></connectionPointIn></variable>
                <variable formalParameter="Tare_Semi"><connectionPointIn><connection refLocalId="10008" /></connectionPointIn></variable>
              </inputVariables>
              <inOutVariables />
              <outputVariables>
                <variable formalParameter="Weight_Auto" />
                <variable formalParameter="Weight_Semi" />
                <variable formalParameter="Auto_Fault" />
                <variable formalParameter="Semi_Fault" />
                <variable formalParameter="Bus_Busy" />
                <variable formalParameter="Active_Node" />
              </outputVariables>
            </block>

            <outVariable localId="10020"><position x="550" y="50" /><connectionPointIn><connection refLocalId="10010" formalParameter="Weight_Auto" /></connectionPointIn><expression>GVL.load_cell_auto</expression></outVariable>
            <outVariable localId="10021"><position x="550" y="70" /><connectionPointIn><connection refLocalId="10010" formalParameter="Weight_Semi" /></connectionPointIn><expression>GVL.load_cell_semi_auto</expression></outVariable>

            <!-- Network 2: Auto_Ctrl (Auto_Batching_V14) -->
            ...
            <!-- Network 3: Semi_Auto_Ctrl (Semi_Auto_Batching_V14) -->
...
with open(log_path, "w") as f:
    try:
        ...
        old_b = proj.find("batching14", True)
        for b in old_b:
            b.remove()
        f.write("Removed old batching14.\n")
        
        app.import_xml(xml_path)
        f.write("Imported updated batching14 FBD.\n")
