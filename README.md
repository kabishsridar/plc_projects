...
| :---: | :--- | :--- | :--- | :--- |
| **`1`** | Configuration | `Error 1: Duplicate Material ID mapped in Auto and Manual!` | Same active Material ID (excluding 0) is mapped to both Auto and Manual arrays. | Re-configure mapping list. |
...
| **`30`** | Operator | `Manual Error: Error 30: Manual Operator Timeout!` | Manual prompt active for longer than 300 seconds (5 minutes) without completion. | Confirm operator interaction or reset sequence. |
